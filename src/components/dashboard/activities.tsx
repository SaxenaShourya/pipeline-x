...
const Activities = () => {
  return (
   <Card className="p-0 shadow-none border-2 rounded-md w-full h-full flex flex-col">
  
  {/* Header */}
  <div className="pt-4 pl-4 text-sm font-semibold text-gray-800">
    Recent Activity
  </div>

  {/* Scrollable content */}
  <div className="flex-1 min-h-0">
    <ScrollArea className="h-full px-3 mx-1">
          ...
          <div key={index}>
            <div className="flex items-center gap-3 py-2">
              ...
              <div className="flex-1 text-xs text-gray-600">
                ...
                <p>
                  {user.action}{" "}
                  <span className="font-semibold">{user.product}</span>
                </p>
              </div>
